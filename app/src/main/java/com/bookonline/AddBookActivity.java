...
import com.bookonline.databinding.ActivityAddBookBinding;
...
public class AddBookActivity extends AppCompatActivity {
    ...
    private void uploadDataToDb(String uploadedPdfUrl, String uploadedImgUrl, long timestamp) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance("https://bookonline-2021a-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Books");
        ref.child(""+timestamp)
                .setValue(hashMap)
